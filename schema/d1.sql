...
CREATE INDEX IF NOT EXISTS idx_version_comments_version_created_at
  ON version_comments (version_id, created_at, id);

CREATE INDEX IF NOT EXISTS idx_version_comments_fingerprint_created_at
  ON version_comments (ip_hash, ua_hash, created_at);

CREATE INDEX IF NOT EXISTS idx_version_comments_hidden_created_at
